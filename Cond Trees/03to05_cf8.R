...
saveRDS(fit.df03to05ADLT, "03to05ADLT_cf8.rds")         # Save fit dataset
write.csv(varimps, file ="03to05ADLT_cf8_imp.csv", 
...
saveRDS(pred, "cf8_test_pred.rds")

# Examine AUROC
pred <- readRDS("cf8_test_pred.rds")
rf.pred = prediction(pred$fitted.values, pred$actual)
rf.perf = performance(rf.pred,"tpr","fpr")
plot(rf.perf,main="ROC for ADLT 03-05:  Run 8",col=2,lwd=2)
