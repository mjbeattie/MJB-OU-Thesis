...
save( codaSamples , file=paste0("a1poly_50r3","coda.Rdata") )

s1 <- summary(codaSamples)
s1

#dicSamples <- extract(runJagsOut, what='dic') 
#save( dicSamples, file=paste0("a1poly_50r3","DIC.Rdata"))

library(ggmcmc)
s = ggs(codaSamples)
save (s, file=paste0("a1poly_50r3", "ggs.Rdata"))
